...
SECTION_SLUG_ALIASES = {
    ...
    'Multi-pass Self-Attention': 'multi-pass-self-attention',
    'FlashAttention': 'flashattention',
    'FlashAttention (Tiling)': 'flashattention-tiling',
    'FlashAttention 流程': 'flashattention-flow',
    '前向扫描': 'forward-scan',
    '前向保存内容': 'forward-saved-state',
    'Online Softmax': 'online-softmax',
    '反向传播': 'backward',
    '为什么重算划算': 'why-recompute-pays-off',
